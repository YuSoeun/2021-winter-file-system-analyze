...
public:
  ...
  auto operator=(ByteBuffer2 const& rhs) -> ByteBuffer2&;

 ~ByteBuffer2();

public:
  auto set_owner() -> ByteBuffer2&;

  auto resize(int to) -> int;
  auto append(ByteBuffer2 const& b) -> ByteBuffer2&;
  auto append(ByteBuffer2* b) -> ByteBuffer2&;
